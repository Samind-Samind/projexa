...
> บทบาททั้ง 3 นี้จริงในแอป (role ยังเป็นแค่แนวคิดที่ใช้แยกความรับผิดชอบใน
...
- Role-based access control (แยกสิทธิ์อ่าน/เขียนตาม SA/ผู้รับผิดชอบ/PM จริงใน `firestore.rules`) — ตอนนี้แค่ต้องล็อกอิน (`request.auth != null`) เท่านั้น ไม่เช็ค role
